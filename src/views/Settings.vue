    ...
    <div id="settings">
      <div class="categories-area">
        <div
          ...
          :key="category"
          :class="{ chosen: index === curCategoryIdx }"
          @click="setCurCategoryIdx(index)"
          role="button"
          tabindex="0"
      ...
      <div class="content-area">
        <div v-if="curCategoryIdx === 0" class="board-pieces">
          <div class="left-side">
            ...
            <Dropdown
              id="board-theme"
              :options="allBoardThemes"
              :selectedValue="curBoardTheme"
              @update:board-theme="changeBoardTheme"
            />
            <div>Piece set</div>
            <Dropdown
              id="piece-theme"
              :options="allPieceThemes"
              :selectedValue="curPieceTheme"
              @update:piece-theme="changePieceTheme"
            />
          </div>
          <Board inert class="zoom-board" />
        </div>
        <div v-if="curCategoryIdx === 1">Sound</div>
      </div>
    </div>
  </div>
</template>
